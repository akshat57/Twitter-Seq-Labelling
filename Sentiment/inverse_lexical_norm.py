...
def inorm_sym(data, twitter_symbols, random_placement = False, random_symbol_selection = True, threshold = 0.25):
    ...
    for (label, sentence, _) in data:
        ...
        augmented_data.append((label, recombined_sentence))
...
if __name__ == '__main__':
    ...
    train_filename = 'Dataset/SST2/train_ner.pkl'
    train_dataset = load_data(train_filename)

    #augmented_data = inorm_sym(train_dataset, twitter_symbols, random_placement = False, random_symbol_selection = True, threshold = 0.25)

    #augmented_data = do_ilexnorm(train_dataset, threshold = 0.75)
    ...
    save_data('Dataset/SST2/train_ILN.pkl', augmented_data)
